 ...
 * @author Win 10
 */
@WebServlet(name = "ShoppingHistoryServlet", urlPatterns = {"/ShopHistoryServlet"})
public class ShoppingHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "/WEB-INF/view"+SHOP_HISTORY_PAGE;
        try {
            ...
            List<PurchasedItem> listPurchasedItem = invoiceDetailDAO.getAllPurchasedItems(userId);
            if(listPurchasedItem!=null){
                session.setAttribute("listPurchasedItem", listPurchasedItem);
                session.setAttribute("currentDate", getCurrentDate());
            }
        } catch (Exception e) {
            log("ShoppingHistoryServlet_processRequest:"+e.getMessage());
        }finally{
